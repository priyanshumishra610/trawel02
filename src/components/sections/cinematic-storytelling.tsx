  ...
  return (
    <section ref={sectionRef} className="relative bg-background">
      {storyPanels.map((panel, i) => (
        ...
        >
          <div className="panel-image absolute inset-0 w-full h-full">
            <img
              src={panel.image}
              alt={panel.headline}
          ...
          <div className="panel-overlay absolute inset-0 bg-black" />
          
          <div className="absolute inset-0 bg-gradient-to-t from-background via-transparent to-background/50 pointer-events-none" />

          <div className="relative z-10 text-center px-6 max-w-5xl">
            <span className="panel-tagline block text-primary text-[10px] md:text-[12px] uppercase tracking-[0.6em] font-bold mb-6">
              {panel.tagline}
            </span>
            <h2 className="panel-headline font-display text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 tracking-tight leading-none">
              {panel.headline}
            </h2>
            <p className="panel-subtext text-white/60 text-xl md:text-2xl font-light tracking-wide">
              {panel.subtext}
            </p>
          </div>
        </div>
